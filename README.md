...
<body data-silex-id="body-initial" class="body-initial silex-runtime" data-silex-type="container">
    ...
    <div data-silex-type="text" class="editable-style silex-id-1518053550861-3 text-element" data-silex-id="silex-id-1518053550861-3" style="">
        <div class="silex-element-content normal">
            <h1 class="heading1">
                <font size="7">Welcome to the ALT site of Babisquad</font>
            </h1>
        </div>
    </div>
    <div data-silex-type="text" class="editable-style silex-id-1518053585867-4 text-element" data-silex-id="silex-id-1518053585867-4" style="">
        <div class="silex-element-content normal">This site is run by DrBDude Co-Founder of babisquad, you can find the main one&nbsp;<a href="http://babisquad.tk">here.</a></div>
    </div>
</body>
